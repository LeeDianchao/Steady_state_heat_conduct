...
! GaussSeidel_main_omp.f90

program GaussSeidel_main
    implicit none
    ...
    write (*,"('Solving Laplace equation on',i4,' by',i4,' grid by Gauss Seidel iteration')") n,n
    ...
    nthreads = 1
    call GaussSeidel_sub(n, tol, maxiter, iter, dumax, nthreads)

    nthreads = 2
    call GaussSeidel_sub(n, tol, maxiter, iter, dumax, nthreads)


end program GaussSeidel_main
